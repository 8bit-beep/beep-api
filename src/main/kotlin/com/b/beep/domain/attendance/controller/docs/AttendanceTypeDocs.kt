...
interface AttendanceTypeDocs {
    ...
    fun getType(@Parameter(description = "출석 타입 ID") id: Long): AttendanceTypeResponse

    @Operation(summary = "출석 타입 수정", description = "출석 타입을 수정합니다.")
    fun updateType(
        @Parameter(description = "출석 타입 ID") id: Long,
        request: UpdateAttendanceTypeRequest
    ): AttendanceTypeResponse

    @Operation(summary = "출석 타입 삭제", description = "출석 타입을 삭제합니다.")
    fun deleteType(@Parameter(description = "출석 타입 ID") id: Long)
}
